...
class NewGameAi extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NewGameAi> createState() => _NewGameAiState();
}

class _NewGameAiState extends ConsumerState<NewGameAi> {
